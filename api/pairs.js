...
export default async function handler(req, res) {
  ...
  // опциональный бесплатный ключ fxratesapi (повышает лимиты) — задаётся в Vercel env
  ...
  try {
    ...
    // более длинный edge-кэш: бережём лимит fxratesapi (апстрим дёргается ~раз в минуту)
