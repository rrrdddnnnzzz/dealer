...
export default async function handler(req, res) {
  ...
  const SECIDS = ['RUSFAR', 'RUSFARRT', 'RUSFARN', 'RUSFAR1W', 'RUSFAR2W', 'RUSFAR1M', 'RUSFAR3M', 'RUSFARCNY'];
  const TERM = {
    RUSFAR: 'ON', RUSFARRT: 'RT', RUSFARN: 'NC',   // NC = RUSFAR Real Time Compound
    RUSFAR1W: '1W', RUSFAR2W: '2W', RUSFAR1M: '1M', RUSFAR3M: '3M',
    RUSFARCNY: 'CNY',   // o/n фондирование в юанях
  };
